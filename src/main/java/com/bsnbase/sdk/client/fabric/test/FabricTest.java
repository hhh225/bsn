...
public class FabricTest {
	...
	public void initConfig() throws IOException {
		...
		config.setAppCode("app0001202103181610190285534");
		config.setUserCode("USER0001202103181024447713887");
		config.setApi("https://ningdemobilenode.bsngate.com:17602");
		config.setPrk(Common.readLocalFile("D:\\graduatedesign\\develop\\certificates\\userAppCert\\private_key.pem"));
		config.setPuk(Common.readLocalFile("D:\\graduatedesign\\develop\\certificates\\userAppCert\\public_cert.pem"));
    ...
    public void reqChainCode() {
    	try {
			...
			//String[] args = {"{\"baseKey\":\"test2020051\",\"baseValue\":\"我是小红 \"}"};
			String[] args = {"testabcdefgh"};
			reqkey.setArgs(args);
			//reqkey.setFuncName("set");
			reqkey.setFuncName("get");
			reqkey.setChainCode("cc_app0001202103181610190285534_01");
			//reqkey.setUserName("test57");
    ...
    public void getTransaction() {
		try {
			...
			reqData.setTxId("095f6b16f898af58471917c8d5a1e88f3307a128fb26cd1ba526cb633d4127ff");
    ...
    public void getBlockInfo() {
		try {
			...
			rbf.setTxId("095f6b16f898af58471917c8d5a1e88f3307a128fb26cd1ba526cb633d4127ff");
